...
export interface FormData {
  ...
  selectedIndex?: number | null; // index of selected product
  products: {
    name: string;
    subProducts: string[];
    status: string; // or consider an enum
  }[];
  newSubProductName: string;
  selectedProductIndex: number; // or string if using string IDs
